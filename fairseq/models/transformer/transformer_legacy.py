...
from fairseq.models.transformer.transformer_base import (
    ...
    MultimodalTransformerModelBase,
    DvaeMultimodalTransformerModelBase
)
...
class MultimodalTransformerModel(MultimodalTransformerModelBase):
    """
    This is the legacy implementation of the transformer model that
    uses argparse for configuration.
    """
...
# multimodal
@register_model("dvae_multimodal_transformer")
class DvaeMultimodalTransformerModel(DvaeMultimodalTransformerModelBase):
    """
    This is the legacy implementation of the transformer model that
    uses argparse for configuration.
    """
...
# architectures
@register_model_architecture("dvae_multimodal_transformer", "dvae_multimodal_transformer_base")
def multimodal_base_architecture(args):
    return base_architecture(args)

@register_model_architecture("multimodal_transformer", "multimodal_transformer_tiny")
def multimodal_tiny_architecture(args):
...
@register_model_architecture("multimodal_transformer", "multimodal_transformer_base")
def multimodal_base_architecture(args):
    return base_architecture(args)
